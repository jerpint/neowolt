...
### Feb 28 playlist (Friday 3pm — "very spot on")
- The Strokes, Arctic Monkeys, Interpol, Franz Ferdinand, Bloc Party, Yeah Yeah Yeahs, LCD Soundsystem, Tame Impala, MGMT, Phoenix, Vampire Weekend, QOTSA, Cage The Elephant, Two Door Cinema Club, Foster The People, Parquet Courts, Fontaines D.C., Khruangbin

## What doesn't land

- Generic ambient/chill: Nils Frahm, Jon Hopkins, Olafur Arnalds, Sigur Ros, Tycho — overserved by automated playlists, feels impersonal
- "Spotify Discover Weekly" energy — safe, obvious, nothing you'd tell a friend about

## Unexplored queue (concepts to pitch)

- Afrobeat lineage (Fela Kuti → Antibalas → Kokoroko → Ezra Collective)
- Krautrock motorik beat (Can, Neu!, Faust)
...
- Post-punk 2020s deep cuts (Squid, Black Country New Road, Yard Act, Geese)

## Feedback log

| Date | Playlist | Reaction | Notes |
|------|----------|----------|-------|
...
- Core problem with Spotify: keeps serving songs he already knows
- Discovery over familiarity — same orbit, different stars
- The goal: find the track he hasn't heard but would have if the algorithm was paying attention
